...
import './contact.css'
import { contactlenses } from "../../utils/data";
        ...
        < div  className="parent">
            {
                ...
                return(
             < div className="child">
               <img src={item.image} alt="contact-Lenses" />
               <p> {item.name}</p>
               <p>Price: {item.price}KSH </p>
               <p  className="wish" onClick={() => handleFavorites(item)} > Add to Wishlist <FaHeart className="nav-icon" /> </p>
